...
var _hasSameObjectStructure = function hasSameObjectStructure(obj1, obj2) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (!_hasSameObjectStructure(obj1[_key], obj2[_key])) {
        return false;
      }
    }
...
export { _hasSameObjectStructure as hasSameObjectStructure };
