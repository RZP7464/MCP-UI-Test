...
import { hasSameObjectStructure as _hasSameObjectStructure } from '../../utils/hasSameObjectStructure/hasSameObjectStructure.js';
...
var overrideTheme = function overrideTheme(_ref) {
  ...
  if (false) {
    if (!_hasSameObjectStructure(baseThemeTokens, bladeTheme)) {
      throwBladeError({
