...
var getProps = function getProps(_ref3) {
  ...
  if (variant === 'tertiary' && color !== 'primary' && color !== 'white' && color !== 'transparent') {
    throwBladeError({
      ...
      message: "Tertiary variant can only be used with color: \"primary\" or \"white\" or \"transparent\" but received \"".concat(color, "\"")
    });
  }
  ...
  var props = {
    ...
    hoverIconColor: getIn(theme.colors, getTextColorToken({
      property: 'icon',
      variant: variant,
      color: color,
      state: 'hover'
...
var _BaseButton = function _BaseButton(_ref5, ref) {
  ...
  var _getProps = getProps({
    ...
    hoverIconColor = _getProps.hoverIconColor,
  ...
  return /*#__PURE__*/jsx(StyledBaseButton, _objectSpread(_objectSpread(_objectSpread(_objectSpread({
    ...
    onKeyDown: function onKeyDown(event) {
      ...
      _onKeyDown === null || _onKeyDown === void 0 || _onKeyDown(event);
    },
    onTouchStart: function onTouchStart(event) {
      handlePointerPressedIn();
      _onTouchStart === null || _onTouchStart === void 0 || _onTouchStart(event);
    },
    onTouchEnd: function onTouchEnd(event) {
      handlePointerPressedOut();
      _onTouchEnd === null || _onTouchEnd === void 0 || _onTouchEnd(event);
    },
    type: type,
    ...
    width: width,
    isPressed: isPressed,
    hoverIconColor: isDisabled ? getIn(theme.colors, iconColor) : hoverIconColor,
