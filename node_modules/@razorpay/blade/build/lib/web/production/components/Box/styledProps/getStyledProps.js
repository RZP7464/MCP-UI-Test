 ...
 * Removing undefined styledProps because when used with spread operator, undefined can override the earlier defined values.
  ...
  * ```
  */
var removeUndefinedStyledProps = function removeUndefinedStyledProps(obj) {
  var onlyDefinedStyledProps = {};
  for (var key in obj) {
 ...
 */
var makeStyledProps = function makeStyledProps(props) {
  return {
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
var getStyledProps = function getStyledProps(props) {
