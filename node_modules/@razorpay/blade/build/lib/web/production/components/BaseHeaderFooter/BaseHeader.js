  ...
  React__default.useEffect(function () {
    if (/*#__PURE__*/React__default.isValidElement(trailing)) {
      ...
      if (false) {
        if (!restrictedProps) {
          throwBladeError({
            message: "Only one of `".concat(allowedComponents.join(', '), "` component is accepted as trailing"),
            moduleName: 'Header'
          });
        }
      }
      ...
      for (var _i = 0, _restrictedPropKeys = restrictedPropKeys; _i < _restrictedPropKeys.length; _i++) {
        ...
        if (trailing !== null && trailing !== void 0 && (_trailing$props = trailing.props) !== null && _trailing$props !== void 0 && _trailing$props.hasOwnProperty(prop)) {
          logger({
            message: "Do not pass \"".concat(prop, "\" to \"").concat(trailingComponentType, "\" while inside Header trailing, because we override it."),
            moduleName: 'Header',
            type: 'warn'
          });
        }
          ...
          children: /*#__PURE__*/jsx(Box, _objectSpread(_objectSpread({}, centerBoxProps[size$1]), {}, {
            children: /*#__PURE__*/jsx(IconButton, {
              ...
              onClick: function onClick() {
                return onBackButtonClick === null || onBackButtonClick === void 0 ? void 0 : onBackButtonClick();
              },
