...
import '../getColorScheme/index.js';
import { colorSchemeNamesInput } from '../../tokens/theme/theme.js';
import '../logger/index.js';
import { getColorScheme } from '../getColorScheme/getColorScheme.web.js';
  ...
  var setColorScheme = useCallback(function setThemeMode(colorScheme) {
    if (true) {
      if (!colorSchemeNamesInput.includes(colorScheme)) {
        throwBladeError({
          message: "Expected color scheme to be one of [".concat(colorSchemeNamesInput.toString(), "] but received ").concat(colorScheme),
