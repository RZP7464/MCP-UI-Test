...
type ColorNeutralStaticScale = Readonly<{
    10: string;
    25: string;
    50: string;
    100: string;
...
type EasingString = `easing.${keyof Easing}`;
type DurationString = `duration.${keyof Duration}`;
type DelayString = `delay.${keyof Delay}`;
...
export { Border, Breakpoints, Color, ColorSchemeNames, ColorSchemeNamesInput, ColorsWithModes, DelayString, DurationString, EasingFactoryFn, EasingString, Elevation, ElevationWithColorModes, FontFamily, FontSize, Motion, Opacity, Size, Spacing, ThemeTokens, Typography, TypographyPlatforms, TypographyWithPlatforms, bladeTheme, border, breakpoints, colors, createTheme, elevation, motion, opacity, overrideTheme, size, spacing, typography };
