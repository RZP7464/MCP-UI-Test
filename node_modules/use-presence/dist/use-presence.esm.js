...
isVisible, opts) {
  ...
  var _useState = useState(initialEnter ? false : isVisible),
      animateIsVisible = _useState[0],
      setAnimateIsVisible = _useState[1];

  var _useState2 = useState(isVisible),
      isMounted = _useState2[0],
      setIsMounted = _useState2[1];

  var _useState3 = useState(initialEnter ? false : isVisible),
...
function usePresenceSwitch(item, opts) {
  ...
  var _useState2 = useState(item !== undefined),
...
export { usePresenceSwitch };
//# sourceMappingURL=use-presence.esm.js.map
